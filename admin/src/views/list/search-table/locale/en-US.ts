export default {
  ...
  'searchTable.form.worknumber': 'Filter Type',
  'searchTable.form.worknumber.artificial': 'artificial',
  'searchTable.form.worknumber.rules': 'Rules',
  ...
  'searchTable.columns.worknumber': 'Filter Type',
